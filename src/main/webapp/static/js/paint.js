...
//前进
    ...
    $("#pen").click(function () {
        ...
        // canvas.freeDrawingBrush.width=document.getElementById("penSize").value
        // canvas.freeDrawingBrush.width=$("#penSize").value
    })
    ...
    //画笔粗细范围条
    document.getElementById("penSize").onchange = function(){
        const x = document.getElementById("penSize").value;
